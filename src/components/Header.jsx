...
function Header() {
    ...
    return (
        <>
            <header className="relative bg-[#fff]">{/* #141625 dark*/}
                <div className="flex items-center justify-between p-2 border-b border-b-[#7b5df9]">
                    <button
                        onClick={onMobileMainOpen}
                        className="p-1 transition-colors duration-200 rounded-md text-[#383b53] bg-[#f5f6ff] hover:text-[#26293f] hover:bg-[#e8e9f3] md:hidden focus:outline-none focus:ring"
                    > {/* text-[rgba(123,93,249,1)]  bg-[#26293f] hover:text-gray-100 hover:bg-[rgba(123,93,249,0.5)] dark*/}
                    ...
                    <Link to={"#"} className="inline-block tracking-wider">
                        <img src={imLogoBlack } alt="invoice manager logo" className='w-11 h-11'/>
                    </Link>
                    <button
                    ...
                    <nav className="hidden space-x-2 md:flex md:items-center">
                        <button className="relative focus:outline-none">
                            <div className="w-12 h-6 transition rounded-full outline-none bg-[rgba(123,93,249,0.3)]"></div> {/* bg-[rgba(123,93,249,1)]  dark*/}
                            <div className="absolute top-0 left-0 inline-flex items-center justify-center w-6 h-6 transition-all duration-150 transform scale-110 rounded-full shadow-sm translate-x-6 text-gray-800 bg-[#fff]"> {/* bg-[#343749]  text-gray-100 dark*/}
                                <MoonIcon/>
                                {/* <SunIcon/> */}
                            </div>
                        </button>
                        <button
                            className="p-2 transition-colors duration-200 rounded-full text-[#383b53] bg-[#f5f6ff] hover:text-[#26293f] hover:bg-[#e8e9f3] focus:outline-none focus:bg-primary-100 focus:ring-primary-darker">
                    ...
                    <nav
                        className={`absolute flex items-center p-4 bg-[#fff] rounded-md shadow-lg top-16 inset-x-4 md:hidden transition duration-300 ease-in-out transform${isMobileSubMenuOpen ? 'opacity-100 translate-y-0 block' : 'opacity-0 -translate-y-full hidden'}`}
                    >{/*bg-[#141625] dark mode */}
                ...
                <div className={`border-b border-b-[#7b5df9] md:hidden ${isMobileMainMenuOpen ? 'block' : 'hidden'}`}>
                    ...
                    <div>
                            <NavLink to={"/home"}  className={({ isActive }) =>isActive ? "text-gray-900 bg-[rgba(123,93,249,0.5)] rounded-md flex items-center gap-2 mt-[0.7em] text-light p-2" : " p-2 flex items-center gap-2 mt-[0.7em] text-light text-gray-900 hover:bg-[rgba(123,93,249,0.5)] rounded-md"}> {/* dark cofr sidebar */}
                                <span><HomeIcon/></span>
                                <span>Accueil</span>
                            </NavLink>
                        </div>
                        <div>
                            <NavLink  to={"/statistiques"} className={({ isActive }) =>isActive ? "text-gray-900 bg-[rgba(123,93,249,0.5)] rounded-md flex items-center gap-2 mt-[0.7em] text-light p-2" : " p-2 flex items-center gap-2 mt-[0.7em] text-light text-gray-900 hover:bg-[rgba(123,93,249,0.5)] rounded-md"}>
                                <span><ChartIcon/></span>
