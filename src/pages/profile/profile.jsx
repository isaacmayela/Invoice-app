...
function Profile() {
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between px-4 py-4 border-b dark:border-b-[rgba(123,93,249,0.7)] lg:py-6 dark:border-primary-darker">
          ...
          <div className="col-span-5 xl:col-span-3">
            <div className="rounded-md  bg-white shadow-default dark:bg-[#141625]">
              <div className="border-b py-4 px-7 dark:border-b-[rgba(123,93,249,0.7)]">
